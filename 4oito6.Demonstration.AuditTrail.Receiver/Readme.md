...
Execute unit tests
```
    cd "4oito6.Demonstration.AuditTrail.EntryPoint/test/4oito6.Demonstration.AuditTrail.EntryPoint.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "4oito6.Demonstration.AuditTrail.EntryPoint/src/4oito6.Demonstration.AuditTrail.EntryPoint"
